...
void initScene() {
  ...
  // Load textures
  texture_grass.reload("../assets/textures/grass.jpg", TEXTURE_JPG);
  texture_grass.setUnit(1);
  texture_mud.reload("../assets/textures/mud.jpg", TEXTURE_JPG);
  texture_mud.setUnit(2);
  texture_snow.reload("../assets/textures/snow.jpg", TEXTURE_JPG);
  texture_snow.setUnit(3);
  texture_snowflake.reload("../assets/textures/snowflake.png", TEXTURE_PNG);
  texture_snowflake.setUnit(4);
  texture_white.reload("../assets/textures/white.jpg", TEXTURE_JPG);
  texture_white.setUnit(5);
  texture_billboard.reload("../assets/textures/billboard.png", TEXTURE_PNG);
  texture_billboard.setUnit(6);
  texture_wood.reload("../assets/textures/container.jpg", TEXTURE_JPG);
  texture_wood.setUnit(7);
  texture_gameover.reload("../assets/textures/gameover.png", TEXTURE_PNG);
  texture_gameover.setUnit(8);
  texture_win.reload("../assets/textures/win.png", TEXTURE_PNG);
  texture_win.setUnit(9);
  texture_sbb.reload("../assets/textures/snowball_barrier.jpg", TEXTURE_JPG);
  texture_sbb.setUnit(10);
...
void updateScene() {
  ...
  if (drawSnow) {
    ...
    if (factor < 0.9f) {  // For changing texture
